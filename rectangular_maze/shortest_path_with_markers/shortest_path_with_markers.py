...
def OptimumPath(markers, initial, final, filePath):
    shortest = range(5000)
...
def main(filePath, flag = 0):
    ...
    pathArray = findOptimumPath(list(listOfMarkers.values()), initial_point, final_point, filePath) ## Acquire the list of paths for optimum traversal.
    print(pathArray)
...
if __name__ == "__main__":
    filePath = "maze09.jpg"                        ## Insert filepath of image here
    img = main(filePath)                 
